 ...
 * modified strictly for WALT setups.
 * 
 * Copyright (C) 2016, Intel Corporation
 * Schedutil Author: Rafael J. Wysocki <rafael.j.wysocki@intel.com>
 *
 * Copyright (C) 2025-2026, skye-tachyon.
 * Wa-uag Author: skye-tachyon <sonicgames772@gmail.com>
 */
...
#define NL_RATIO 75
#define DEFAULT_HISPEED_LOAD 97
#define DEFAULT_CPU0_RTG_BOOST_FREQ 633600
#define DEFAULT_CPU4_RTG_BOOST_FREQ 633600
				...
				unsigned int flags)
{
	...
	busy = !wg_policy->need_freq_update &&
...
static int waltgov_init(struct cpufreq_policy *policy)
{
	...
	tunables->adaptive_low_freq = 633600;
	tunables->adaptive_high_freq = 902400;
	tunables->hispeed_freq = 1670400;
	switch (policy->cpu) {
	default:
	case 0:
